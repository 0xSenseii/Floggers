...
var app = (function () {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$1, 34, 4, 795);
    			add_location(p, file$1, 41, 4, 914);
    			attr_dev(div, "class", "cards__item svelte-1mevzd4");
    			add_location(div, file$1, 33, 0, 765);
    		},
    ...
    // (121:3) {#each legis as pog}
    function create_each_block_1(ctx) {
    	let pogger;
    	let current;

    	pogger = new Pogger({
    			props: { poggername: /*pog*/ ctx[4].name },
    			$$inline: true
    		});
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(121:3) {#each legis as pog}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(link4, file, 102, 1, 1521);
    			document.title = "Poggers Floor Prices";
    			attr_dev(h1, "class", "svelte-oxjnby");
    			add_location(h1, file, 113, 1, 1878);
    			attr_dev(div0, "class", "cards svelte-oxjnby");
    			add_location(div0, file, 114, 1, 1908);
    			attr_dev(div1, "class", "normies svelte-oxjnby");
    			add_location(div1, file, 126, 2, 2141);
    			attr_dev(div2, "class", "legis svelte-oxjnby");
    			add_location(div2, file, 127, 2, 2178);
    			attr_dev(div3, "class", "category svelte-oxjnby");
    			add_location(div3, file, 125, 1, 2116);
    			...
    			add_location(a, file, 129, 1, 2241);
    			attr_dev(main, "class", "svelte-oxjnby");
    			add_location(main, file, 112, 0, 1870);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(div2, "click", /*showLegis*/ ctx[3](), false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, [dirty]) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Pogger, pogs, legis, legistab, showLegis });
    	...
    	return [legistab, pogs, legis, showLegis];
    }
