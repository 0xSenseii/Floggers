...
var app = (function () {
    ...
    /* src/components/Category.svelte generated by Svelte v3.42.3 */

    const { console: console_1$1 } = globals;
    const file$4 = "src/components/Category.svelte";
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			a = element("a");
    			a.textContent = "Show Legis";
    			attr_dev(a, "href", "#");
    			attr_dev(a, "class", "svelte-1b6hbgi");
    			add_location(a, file$4, 9, 4, 156);
    			attr_dev(div, "class", "category svelte-1b6hbgi");
    			add_location(div, file$4, 8, 0, 129);
    		},
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	function showLegis() {
    		$$invalidate(1, legis = true);
    		console.log("clicked");
    	}

    	const writable_props = ['legis'];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1$1.warn(`<Category> was created with unknown prop '${key}'`);
    	});

    	const click_handler = () => showLegis();

    	$$self.$$set = $$props => {
    		if ('legis' in $$props) $$invalidate(1, legis = $$props.legis);
    	};

    	$$self.$capture_state = () => ({ legis, showLegis });
    	...
    	return [showLegis, legis, click_handler];
    }

    class Category extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$4, create_fragment$4, safe_not_equal, { legis: 1 });
    		...
    		if (/*legis*/ ctx[1] === undefined && !('legis' in props)) {
    			console_1$1.warn("<Category> was created without expected prop 'legis'");
    		}
    	}
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file, 98, 1, 1168);
    			attr_dev(div0, "class", "cards svelte-3ktxnt");
    			add_location(div0, file, 99, 1, 1198);
    			attr_dev(a0, "class", "legis svelte-3ktxnt");
    			attr_dev(a0, "href", "#");
    			add_location(a0, file, 114, 2, 1470);
    			attr_dev(a1, "class", "normies svelte-3ktxnt");
    			attr_dev(a1, "href", "#");
    			add_location(a1, file, 117, 2, 1564);
    			attr_dev(div1, "class", "category svelte-3ktxnt");
    			add_location(div1, file, 113, 1, 1445);
    			...
    			add_location(a2, file, 124, 1, 1677);
    			attr_dev(main, "class", "svelte-3ktxnt");
    			add_location(main, file, 97, 0, 1160);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
